...
check_versions() {
    ...
    haval_latest=$(get_latest_version "https://github.com/igormusardo/haval-app-tool-multimidia")
...
main() {
    ...
    save_version "haval_app" "$(get_latest_version "https://github.com/igormusardo/haval-app-tool-multimidia")"
